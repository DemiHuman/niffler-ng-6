...
public class SpendApiClient {
  ...
  public SpendJson getSpend(Integer id) {
    final Response<SpendJson> response;
    try {
  ...
  public List<SpendJson> getSpend(String username, CurrencyValues filterCurrency, Date from, Date to) {
    final Response<List<SpendJson>> response;
    try {
      response = spendApi.getSpend(username, filterCurrency, from, to)
              .execute();
    } catch (IOException e) {
      throw new AssertionError(e);
    }
